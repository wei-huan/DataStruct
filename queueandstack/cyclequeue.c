...
bool enter_queue(queuearray *Q, datatype newnode)
{
    if (!is_full(Q))
    {
...
bool exit_queue(queuearray *Q, datatype *exitnode)
{
    if (!is_empty(Q))
    {
