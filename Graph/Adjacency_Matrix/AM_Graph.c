...
//创建邻接矩阵形式的图
void Create_AMGraph(Graph_Type *G, 
...
int Locate_AMNode(Graph_Type *G,VertexData_Type VX)
{
    //对图的顶点数组遍历查找
...
//遍历邻接矩阵形式的图
void Traverse_AMGraph(Graph_Type *G)
{
    ;
}//太简单了吧就不写了

//添加顶点
void Add_AMNode(Graph_Type *G,VertexData_Type NodeData)
{
    ;
}//太简单了吧就不写了

//删除顶点
void Delete_AMNode(Graph_Type *G,VertexData_Type NodeData)
{
    ;
}//太简单了吧就不写了

//添加弧
void Add_AMArc(Graph_Type *G,VertexData_Type Head,VertexData_Type Tail)
{
    ;
}//太简单了吧就不写了

//删除弧
void Delete_AMArc(Graph_Type *G,VertexData_Type Head,VertexData_Type Tail)
{
    ;
}//太简单了吧就不写了